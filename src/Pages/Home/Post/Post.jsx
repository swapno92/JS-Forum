...
const Post = ({ post }) => {
    // console.log(post)
    const { authorImage, title, postTime,tag ,_id, vote,comment} = post
    // console.log(authorName)
    
    return (
        <Link to={`postDetails/${_id}`} className="shadow-lg p-4 rounded-lg bg-yellow-50 space-y-3">
            ...
            <div className=" flex justify-between">
                <button className=" px-4 py-2 rounded-lg bg-red-200 font-semibold border border-red-500">Comments : {comment}</button>
